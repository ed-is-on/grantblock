...
import { ImportGranteeService } from './ImportGrantee.service';
import 'rxjs/add/operator/toPromise';
@Component({
	selector: 'app-ImportGrantee',
	templateUrl: './ImportGrantee.component.html',
	styleUrls: ['./ImportGrantee.component.css'],
  providers: [ImportGranteeService]
})
export class ImportGranteeComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceImportGrantee.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: "com.usgov.grantblock.ImportGrantee",
    ...
    return this.serviceImportGrantee.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceImportGrantee.updateTransaction(form.get("transactionId").value,this.Transaction)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceImportGrantee.deleteTransaction(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceImportGrantee.getTransaction(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
