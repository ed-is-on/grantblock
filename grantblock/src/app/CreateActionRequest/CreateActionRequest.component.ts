...
@Component({
	selector: 'app-CreateActionRequest',
	templateUrl: './CreateActionRequest.component.html',
	styleUrls: ['./CreateActionRequest.component.css'],
  providers: [CreateActionRequestService]
})
export class CreateActionRequestComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceCreateActionRequest.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: "com.usgov.grantblock.CreateActionRequest",
    ...
    return this.serviceCreateActionRequest.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceCreateActionRequest.updateTransaction(form.get("transactionId").value,this.Transaction)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceCreateActionRequest.deleteTransaction(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceCreateActionRequest.getTransaction(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
