...
export class TreasuryComponent implements OnInit {
  ...
  constructor(private serviceTreasury:TreasuryService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceTreasury.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: "com.usgov.grantblock.Treasury",
    ...
    return this.serviceTreasury.addParticipant(this.participant)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceTreasury.updateParticipant(form.get("userId").value,this.participant)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceTreasury.deleteParticipant(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceTreasury.getparticipant(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
